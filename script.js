...
bookCardAdd.addEventListener("click", () => {
...
addBookToLibrary("J.R.R Tolkien", "The Hobbit", "296", "Adventure type shi*");
addBookToLibrary("J.K. Rowling", "Harry Potter", "693", "You are a wizard, Harry");
