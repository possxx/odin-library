...
bookTitle.textContent = "The Hobbit";
bookAuthor.textContent = "J.R.R. Tokien";
bookPages.textContent = "Pages: 296";
bookDescription.textContent = "Description: The Hobbit is set in Middle-earth and follows home-loving Bilbo Baggins, the hobbit of the title, who joins the wizard Gandalf and the thirteen dwarves of Thorin's Company, on a quest to reclaim the dwarves' home and treasure from the dragon Smaug.";
